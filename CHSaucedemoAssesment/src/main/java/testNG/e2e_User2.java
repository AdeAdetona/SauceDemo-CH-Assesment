...
public class e2e_User2 {
	...
	// Scenario: Test the end to end journey with locked out user name and correct
	// password
	...
	public void Test_case() throws Exception {
		...
		driver.findElement(By.xpath("//input[@id='user-name']")).sendKeys(Constants.LOCKEDOUTUSER);
