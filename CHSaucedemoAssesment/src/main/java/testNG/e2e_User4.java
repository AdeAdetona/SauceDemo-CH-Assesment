...
public class e2e_User4 {
	...
	// Scenario: Test the end to end journey with performance glitch user name and
	// incorrect password
	...
	public void Test_S4() throws Exception {
		...
		driver.findElement(By.xpath("//input[@id='user-name']")).sendKeys(Constants.PGUSER);
