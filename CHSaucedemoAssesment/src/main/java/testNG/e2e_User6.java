...
public class e2e_User6 {
	...
	// Scenario: Test the end to end journey with incorrect user name and incorrect
	// password

	public void Test_S6() throws Exception {
		...
		driver.findElement(By.xpath("//input[@id='password']")).sendKeys(Constants.INCORRECTSTANDARD_USER);
